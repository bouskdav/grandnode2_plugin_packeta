...
{
    public class PacketaShippingController : Controller
    {
        ...
        public PacketaShippingController(
        ...
        //    if (shippingPoint == null) return Content("PacketaShippingController: given Shipping Option doesn't exist");
        ...
        public async Task<IActionResult> Points(string shippingOption)
        {
            ...
            if (parameter != _translationService.GetResource("Shipping.Packeta.PluginName"))
                return Content("PacketaShippingPointController: given Shipping Option doesn't exist");
            ...
            //    new() { Value = "", Text = _translationService.GetResource("Shipping.Packeta.SelectShippingOption") }
            //};
