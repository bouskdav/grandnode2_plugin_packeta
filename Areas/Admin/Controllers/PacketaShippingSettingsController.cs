...
namespace Shipping.Packeta.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    [PermissionAuthorize(PermissionSystemName.ShippingSettings)]
    public class PacketaShippingSettingsController : BaseShippingController
    {
        private readonly IWarehouseService _warehouseService;
        private readonly IShippingMethodService _shippingMethodService;
        private readonly IStoreService _storeService;
        private readonly ICountryService _countryService;
        private readonly PacketaShippingSettings _shippingPacketaSettings;
        private readonly IPacketaShippingService _shippingPacketaService;
        ...
        public PacketaShippingSettingsController(
            IWarehouseService warehouseService,
            IShippingMethodService shippingMethodService,
            IStoreService storeService,
            ICountryService countryService,
            PacketaShippingSettings shippingPacketaSettings,
            IPacketaShippingService shippingPacketaService,
            ...
            MeasureSettings measureSettings)
        {
            ...
            _shippingPacketaSettings = shippingPacketaSettings;
            _shippingPacketaService = shippingPacketaService;
        ...
        {
            var model = new PacketaShippingListModel();

            model.LimitMethodsToCreated = _shippingPacketaSettings.LimitMethodsToCreated;
            model.DisplayOrder = _shippingPacketaSettings.DisplayOrder;
        ...
        public async Task<IActionResult> SaveGeneralSettings(PacketaShippingListModel model)
        {
            //save settings
            _shippingPacketaSettings.LimitMethodsToCreated = model.LimitMethodsToCreated;
            _shippingPacketaSettings.DisplayOrder = model.DisplayOrder;

            await _settingService.SaveSetting(_shippingPacketaSettings);
        ...
        //{
        //    var records = await _shippingPacketaService.GetAll(command.Page - 1, command.PageSize);

        //    var sbwModel = new List<PacketaShippingModel>();
        //    foreach (var x in records)
        //    {

        //        var m = new PacketaShippingModel
        //        {
        //            Id = x.Id,
        //            StoreId = x.StoreId,
        ...
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.From"), m.From);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.To"), m.To);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.AdditionalFixedCost"), m.AdditionalFixedCost);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.RatePerWeightUnit"), m.RatePerWeightUnit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.LowerWeightLimit"), m.LowerWeightLimit);
        //        htmlSb.Append("<br />");
        //        htmlSb.AppendFormat("{0}: {1}", _translationService.GetResource("Plugins.Shipping.Packeta.Fields.PercentageRateOfSubtotal"), m.PercentageRateOfSubtotal);
        ...
        //{
        //    var sbw = await _shippingPacketaService.GetById(id);
        //    if (sbw != null)
        //        await _shippingPacketaService.DeletePacketaShippingRecord(sbw);
        ...
        //{
        //    var model = new PacketaShippingModel();
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> AddPopup(PacketaShippingModel model)
        //{
        //    var sbw = new PacketaShippingRecord
        //    {
        ...
        //    };
        //    await _shippingPacketaService.InsertPacketaShippingRecord(sbw);
        ...
        //[HttpPost]
        //[AutoValidateAntiforgeryToken]
        //public async Task<IActionResult> EditPopup(PacketaShippingModel model)
        //{
        //    var sbw = await _shippingPacketaService.GetById(model.Id);
        //    if (sbw == null)
        //        //No record found with the specified id
        //        return RedirectToAction("Configure");
        ...
        //    await _shippingPacketaService.UpdatePacketaShippingRecord(sbw);
